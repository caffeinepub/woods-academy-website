      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto">
            We'd love to hear from you. Reach out to us for admissions, enquiries, or any information about Woods Academy.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="text-primary">School Information</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">infowoodsacademy@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Zishanul Haque</p>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-sm">Nursery – Class 8</span>
                  </div>
                  <div className="flex justify-between">
                ...
                <CardContent>
                  <div className="bg-muted rounded-lg h-64 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">
                      ...
                      <p className="text-sm">Rourkela, Odisha, India – 769001</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
