      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Capturing memorable moments from our school events, campus life, and
            activities
          </p>
        </div>
        ...
        <Tabs
          ...
          onValueChange={(value) =>
            setSelectedCategory(value as "all" | GalleryCategory)
          }
        >
          <TabsList className="grid w-full grid-cols-4 max-w-2xl mx-auto">
            ...
            <TabsTrigger value={GalleryCategory.activities}>
              Activities
            </TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Students showcasing their talents in dance, music, and drama
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Annual sports meet with various athletic competitions
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Students exploring their creativity through various art
                    forms
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our lush green campus spread across 15 acres
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Welcoming entrance to Woods Academy
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Modern classrooms equipped with latest technology
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    State-of-the-art labs for practical learning
                  </p>
                </CardContent>
              </Card>
