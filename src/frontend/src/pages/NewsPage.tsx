        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <Card className="border-l-4 border-l-primary">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Admissions are now open for all classes from Nursery to Class
                  12. Parents can visit the school office or fill out the online
                  enquiry form. Limited seats available. Early registration is
                  encouraged.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-accent-green">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Parent-Teacher meetings will be held on February 5-6, 2025.
                  Parents are requested to meet their ward's class teacher to
                  discuss academic progress. Appointment slots can be booked
            ...
            <Card className="border-l-4 border-l-primary">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Our Annual Sports Day will be held on February 15, 2025, at
                  the school sports complex. All students are required to
                  participate. Parents are cordially invited to attend and
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Students will showcase their innovative science projects
                      and experiments
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Grand celebration featuring cultural performances, awards,
                      and achievements
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Various competitions including debate, quiz, and cultural
                      activities
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Expert guidance for Class 10 and 12 students on career
                      options
                    </p>
                  </div>
                </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Results for the first term examinations have been
                      published. Parents can collect report cards from the
                      school office or access them through the parent portal.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The annual examination schedule for all classes will be
                      announced by February 10, 2025. Students are advised to
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Special preparation classes for Class 10 and 12 board
                      examinations will commence from February 1, 2025.
